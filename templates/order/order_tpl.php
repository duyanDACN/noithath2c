		...
		<div class="section-cart">
			...
			<div class="information-cart">
				<div class="input-double-cart w-clear">
					...
					<div class="input-cart">
						<input type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="dienthoai" name="dienthoai" value="<?=!empty($_SESSION[$login_member]['dienthoai'])?$_SESSION[$login_member]['dienthoai']:''?>" placeholder="<?=sodienthoai?>" required />
