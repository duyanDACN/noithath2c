...
$requick = array(
	...
	/* Tin tức */
		array("tbl"=>"news_list","field"=>"idl","source"=>"news","com"=>"dich-vu-thiet-ke","type"=>"dich-vu-thiet-ke"),

	array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"dich-vu-thiet-ke","type"=>"dich-vu-thiet-ke",'menu'=>true),
	...
	array("tbl"=>"static","field"=>"id","source"=>"static","com"=>"quy-trinh","type"=>"quy-trinh"),
...
switch($com)
{
	...
	case 'dich-vu-thiet-ke':
	$source = "news";
	$template = isset($_GET['id']) ? "news/news_detail" : "news/news";
	$seo->setSeo('type',isset($_GET['id']) ? "article" : "object");
	$type = $com;
	$title_crumb = "Thiết kế";
	break;
