<?php 
	...
	if(isset($_POST['submit-contact']))
	{
        ...
        if(($scoreCaptcha >= 0.5 && $actionCaptcha == 'contact') || $testCaptcha == true)
		{
			...
			$data['congtrinh'] = (isset($_POST['congtrinh']) && $_POST['congtrinh'] != '') ? htmlspecialchars($_POST['congtrinh']) : '';
			$data['phongcach'] = (isset($_POST['phongcach']) && $_POST['phongcach'] != '') ? htmlspecialchars($_POST['phongcach']) : '';
			...
			$emailer->setEmail('congtrinhnguoigui',$data['congtrinh']);
			$emailer->setEmail('phongcachnguoigui',$data['phongcach']);
		    ...
		    if($emailer->getEmail('congtrinhnguoigui'))
		    {
		    	$strThongtin .= 'Loại công trình: '.$emailer->getEmail('congtrinhnguoigui').'<br>';
		    }
		    if($emailer->getEmail('phongcachnguoigui'))
		    {
		    	$strThongtin .= 'Phong cách: '.$emailer->getEmail('phongcachnguoigui').'<br>';
		    }
