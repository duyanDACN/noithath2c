...
if($id!='')
{
	...
	/* Robots meta tag */
	$robots = $d->rawQueryOne("select rbindex, canonical, ogsitename, ogtype, ogurl from #_seo where idmuc = ? and com = ? and type = ? limit 0,1",array($row_detail['id'],'product',$type));
