...
// https://github.com/Studio-42/elFinder/wiki/Connector-configuration-options
	...
	// 'debug' => true,
		...
		// Trash volume
			...
			'uploadAllow'   => array('image/x-ms-bmp', 'image/gif', 'image/jpeg', 'video/mp4', 'image/png', 'image/x-icon', 'text/plain'), // Same as above
