<!-- Main Sidebar -->
<aside class="main-sidebar sidebar-dark-primary text-sm" data-background-color="<?=($setting['color_logo']) ? $setting['color_logo'] : 'custom'?>">
    <!-- Logo -->
    <a class="logo-header" href="index.php">
        <img class="brand-image" src="assets/images/vinasoftware.png" alt="Vina Software (VNS)">
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
        <nav class="mt-3">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item <?=$active?>">
                    <a class="nav-link <?=$active?>" href="index.php" title="Bảng điều khiển">
                        <span class="nav-icon-img"><img src="assets/images/menu4.png"></span>
                        <p>Bảng điều khiển</p>
                    </a>
                </li>
                <!-- Group -->
                <?php $disabled = array(); if(isset($config['group'])) { foreach($config['group'] as $key => $value) { ?>
                    <li class="nav-item has-treeview menu-group">
                        <a class="nav-link" href="#" title="Quản lý <?=$key?>">
                            <span class="nav-icon-img"><img src="assets/images/menu1.png"></span>
                            <p>
                                <?=$key?>
                            </p>
                        ...
                        <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <?php if(isset($v['list']) && $v['list'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_list&type=<?=$k?>" title="Danh mục cấp 1"><p>Danh mục cấp 1</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['cat']) && $v['cat'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_cat&type=<?=$k?>" title="Danh mục cấp 2"><p>Danh mục cấp 2</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['item']) && $v['item'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_item&type=<?=$k?>" title="Danh mục cấp 3"><p>Danh mục cấp 3</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['sub']) && $v['sub'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_sub&type=<?=$k?>" title="Danh mục cấp 4"><p>Danh mục cấp 4</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['brand']) && $v['brand'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_brand&type=<?=$k?>" title="Danh mục hãng"><p>Danh mục hãng</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['mau']) && $v['mau'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_mau&type=<?=$k?>" title="Danh mục màu sắc"><p>Danh mục màu sắc</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['size']) && $v['size'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_size&type=<?=$k?>" title="Danh mục kích thước"><p>Danh mục kích thước</p></a></li>
                                        <?php } ?>
                                        <?php
                                        $none = "";
                                        $active = "";
                                        ...
                                        ?>
                                        <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man&type=<?=$k?>" title="<?=$v['title_main']?>"><p><?=$v['title_main']?></p></a></li>
                                        <?php if(isset($v['import']) && $v['import'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>">
                                                <a class="nav-link <?=$active?>" href="index.php?com=import&act=man&type=<?=$k?>" title="Import"><p>Import</p></a>
                                            </li>
                                        <?php } ?>
                                        <?php if(isset($v['export']) && $v['export'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>">
                                                <a class="nav-link <?=$active?>" href="index.php?com=export&act=man&type=<?=$k?>" title="Export"><p>Export</p></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <?php if(isset($v['list']) && $v['list'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=news&act=man_list&type=<?=$k?>" title="Danh mục cấp 1"><p>Danh mục cấp 1</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['cat']) && $v['cat'] == true) {
                                            $none = "";
                                            $active = "";
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=news&act=man_cat&type=<?=$k?>" title="Danh mục cấp 2"><p>Danh mục cấp 2</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['item']) && $v['item'] == true) {
                                            $none = "";
                                            $active = "";
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=news&act=man_item&type=<?=$k?>" title="Danh mục cấp 3"><p>Danh mục cấp 3</p></a></li>
                                        <?php } ?>
                                        <?php if(isset($v['sub']) && $v['sub'] == true) {
                                            $none = "";
                                            $active = "";
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=news&act=man_sub&type=<?=$k?>" title="Danh mục cấp 4"><p>Danh mục cấp 4</p></a></li>
                                        <?php } ?>
                                        <?php
                                        $none = "";
                                        $active = "";
                                        ...
                                        ?>
                                        <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=news&act=man&type=<?=$k?>" title="<?=$v['title_main']?>"><p><?=$v['title_main']?></p></a></li>
                                    </ul>
                                </li>
                            <?php } } ?>
                            <?php if(isset($value['tags'])) { foreach($value['tags'] as $k) { ?>
                                ...
                                ?>
                                <li class="nav-item <?=$none?>">
                                    <a class="nav-link <?=$active?>" href="index.php?com=tags&act=man&type=<?=$k?>" title="<?=$v['title_main']?>"><p><?=$v['title_main']?></p></a>
                                </li>
                            <?php } } ?>
                            <?php if(isset($value['static'])) { foreach($value['static'] as $k) { ?>
                                ...
                                ?>
                                <li class="nav-item <?=$none?>">
                                    <a class="nav-link <?=$active?>" href="index.php?com=static&act=capnhat&type=<?=$k?>" title="<?=$v['title_main']?>"><p><?=$v['title_main']?></p></a>
                                </li>
                            <?php } } ?>
                            <?php if(isset($value['newsletter'])) { foreach($value['newsletter'] as $k) { ?>
                                ...
                                ?>
                                <li class="nav-item <?=$none?>">
                                    <a class="nav-link <?=$active?>" href="index.php?com=newsletter&act=man&type=<?=$k?>" title="<?=$v['title_main']?>"><p><?=$v['title_main']?></p></a>
                                </li>
                            <?php } } ?>
                            <?php if(isset($value['photo'])) { foreach($value['photo'] as $k) {
                                ...
                                <li class="nav-item <?=$none?>">
                                    <a class="nav-link <?=$active?>" href="index.php?com=photo&act=man_photo&type=<?=$k?>" title="<?=$v['title_main_photo']?>"><p><?=$v['title_main_photo']?></p></a>
                                </li>
                            <?php } } ?>
                            <?php if(isset($value['photo_static'])) { foreach($value['photo_static'] as $k) {
                                ...
                                <li class="nav-item <?=$none?>">
                                    <a class="nav-link <?=$active?>" href="index.php?com=photo&act=photo_static&type=<?=$k?>" title="<?=$v['title_main']?>"><p><?=$v['title_main']?></p></a>
                                </li>
                            <?php } } ?>
                        </ul>
                    </li>
                        ...
                        <ul class="nav nav-treeview">
                            <?php if(isset($config['search']['search_static'])) { ?>
                                <?php foreach($config['search']['search_static'] as $k => $v) { if(!isset($disabled['search_static'][$k])) {
                                    ...
                                    <li class="nav-item <?=$none?>">
                                        <a class="nav-link <?=$active?>" href="index.php?com=search&act=search_static&type=<?=$k?>" title="<?=$v['title_main']?>"><p><?=$v['title_main']?></p></a>
                                    </li>
                                <?php } } ?>
                            <?php } ?>
                            <?php if(isset($config['search']['man_search'])) { ?>
                                <?php foreach($config['search']['man_search'] as $k => $v) { if(!isset($disabled['search'][$k])) {
                                    ...
                                    <li class="nav-item <?=$none?>">
                                        <a class="nav-link <?=$active?>" href="index.php?com=search&act=man_search&type=<?=$k?>" title="<?=$v['title_main_search']?>"><p><?=$v['title_main_search']?></p></a>
                                    </li>
                                <?php } } ?>
                            <?php } ?>
                        </ul>
                ...
                <?php if(isset($config['product'])) { ?>
                    <?php foreach($config['product'] as $k => $v) { if(!isset($disabled['product'][$k])) { ?>
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            <a class="nav-link <?=$active?>" href="#" title="Quản lý <?=$v['title_main']?>">
                                <span class="nav-icon-img"><img src="assets/images/menu16.png"></span>
                                <p>
                                    Quản lý <?=$v['title_main']?>
                                </p>
                                <i class="right fas fa-angle-right"></i>
                ...
                <?php if(isset($config['news'])) { ?>
                    <?php foreach($config['news'] as $k => $v) { if(!isset($disabled['news'][$k])) { if(isset($v['dropdown']) && $v['dropdown'] == true) { ?>
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            <a class="nav-link <?=$active?>" href="#" title="Quản lý <?=$v['title_main']?>">
                                <span class="nav-icon-img"><img src="assets/images/menu10.png"></span>
                                <p>
                                    Quản lý <?=$v['title_main']?>
                                </p>
                                <i class="right fas fa-angle-right"></i>
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['news'] as $k => $v) { if(!isset($disabled['news'][$k]) && (!isset($v['dropdown']) || (isset($v['dropdown']) && $v['dropdown'] == false))) { ?>
                                ...
                                ?>
                                <li class="nav-item <?=$none?>">
                                    <a class="nav-link <?=$active?>" href="index.php?com=news&act=man&type=<?=$k?>" title="<?=$v['title_main']?>"><p><?=$v['title_main']?></p></a>
                                </li>
                            <?php } } ?>
                        </ul>
                    </li>
                ...
                <?php if(isset($config['order']['active']) && $config['order']['active'] == true) { ?>
                    ...
                    <li class="nav-item <?=$active?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="index.php?com=order&act=man" title="Quản lý đơn hàng">
                            <span class="nav-icon-img"><img src="assets/images/menu19.png"></span>
                ...
                <?php if(isset($config['tags'])) { ?>
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="#" title="Quản lý tags">
                            <span class="nav-icon-img"><img src="assets/images/menu20.png"></span>
                            <p>
                                Quản lý tags
                            </p>
                            <i class="right fas fa-angle-right"></i>
                ...
                <?php if(isset($config['static'])) { ?>
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="#" title="Quản lý trang tĩnh">
                            <span class="nav-icon-img"><img src="assets/images/menu12.png"></span>
                            <p>
                                Quản lý trang tĩnh
                            </p>
                            <i class="right fas fa-angle-right"></i>
                ...
                <?php if(isset($config['photo'])) { ?>
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="#" title="Quản lý hình ảnh - video">
                            <span class="nav-icon-img"><img src="assets/images/menu13.png"></span>
                            <p>
                ...
                <?php if(isset($config['places']['active']) && $config['places']['active'] == true) { ?>
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="#" title="Quản lý địa điểm">
                            <span class="nav-icon-img"><img src="assets/images/menu17.png"></span>
                            <p>
                                Quản lý địa điểm
                            </p>
                            <i class="right fas fa-angle-right"></i>
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            ?>
                            <li class="nav-item <?=$none?>">
                                <a class="nav-link <?=$active?>" href="index.php?com=places&act=man_city" title="Tỉnh thành"><p>Tỉnh thành</p></a>
                            </li>
                            <?php
                            $none = "";
                            $active = "";
                            ...
                            ?>
                            <li class="nav-item <?=$none?>">
                                <a class="nav-link <?=$active?>" href="index.php?com=places&act=man_district" title="Quận huyện"><p>Quận huyện</p></a>
                            </li>
                            <?php
                            $none = "";
                            $active = "";
                            ...
                            ?>
                            <li class="nav-item <?=$none?>">
                                <a class="nav-link <?=$active?>" href="index.php?com=places&act=man_wards" title="Phường xã"><p>Phường xã</p></a>
                            </li>
                            <?php
                            $none = "";
                            $active = "";
                            ...
                            ?>
                            <li class="nav-item <?=$none?>">
                                <a class="nav-link <?=$active?>" href="index.php?com=places&act=man_street" title="Đường"><p>Đường</p></a>
                            </li>
                        </ul>
                    </li>
                <?php } ?>
                ...
                <?php if(isset($config['user']['active']) && $config['user']['active'] == true && !$func->check_permission()) { ?>
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="#" title="Quản lý user">
                            <span class="nav-icon-img"><img src="assets/images/menu2.png"></span>
                            <p>
                                Quản lý user
                            </p>
                            <i class="right fas fa-angle-right"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <?php if(isset($config['permission']) && $config['permission'] == true) {
                                ...
                                <li class="nav-item"><a class="nav-link <?=$active?>" href="index.php?com=user&act=permission_group" title="Nhóm quyền"><p>Nhóm quyền</p></a></li>
                            <?php } ?>
                            <?php
                            $active = "";
                            if($act=='admin_edit') $active = "active";
                            ?>
                            <li class="nav-item"><a class="nav-link <?=$active?>" href="index.php?com=user&act=admin_edit" title="Thông tin admin"><p>Thông tin admin</p></a></li>
                            <?php if(isset($config['user']['admin']) && $config['user']['admin'] == true) {
                                $active = "";
                                if($act=='man_admin' || $act=='add_admin' || $act=='edit_admin') $active = "active"; ?>
                                <li class="nav-item"><a class="nav-link <?=$active?>" href="index.php?com=user&act=man_admin" title="Tài khoản admin"><p>Tài khoản admin</p></a></li>
                            <?php } ?>
                            <?php if(isset($config['user']['visitor']) && $config['user']['visitor'] == true) {
                                $active = "";
                                if($com=='user' && ($act=='man' || $act=='add' || $act=='edit')) $active = "active"; ?>
                                <li class="nav-item"><a class="nav-link <?=$active?>" href="index.php?com=user&act=man" title="Tài khoản khách"><p>Tài khoản khách</p></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                <?php } ?>
                ...
                <?php if(isset($config['seopage']) && count($config['seopage']['page']) > 0) { ?>
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="#" title="Quản lý SEO page">
                            <span class="nav-icon-img"><img src="assets/images/menu14.png"></span>
                            <p>
                                Quản lý SEO page
                            </p>
                            <i class="right fas fa-angle-right"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <?php foreach($config['seopage']['page'] as $k => $v) { ?>
                                ...
                                ?>
                                <li class="nav-item <?=$none?>">
                                    <a class="nav-link <?=$active?>" href="index.php?com=seopage&act=capnhat&type=<?=$k?>" title="<?=$v?>"><p><?=$v?></p></a>
                                </li>
                            <?php } ?>
                        </ul>
                    </li>
                ...
                ?>
                <li class="nav-item nav-item-scroll <?=$active?> <?=$none?>">
                    <a class="nav-link <?=$active?>" href="index.php?com=setting&act=capnhat" title="Thiết lập thông tin">
                        <span class="nav-icon-img"><img src="assets/images/menu15.png"></span>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        if($(".nav-sidebar .nav-item > .nav-treeview > .nav-item > .nav-link").hasClass("active"))
        {
            offset = $(".nav-sidebar .nav-item > .nav-treeview > .nav-item > .nav-link.active").offset().top;
            $('.sidebar').animate({scrollTop : offset - 100},800);
        }

        if($(".nav-item-scroll").hasClass("active"))
        {
            offset2 = $(".nav-item-scroll").offset().top;
            $('.sidebar').animate({scrollTop : offset2 - 100},800);
        }
