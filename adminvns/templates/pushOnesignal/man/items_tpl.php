                    ...
                    <?php for($i=0;$i<count($items);$i++) { ?>
                        <tr>
                            ...
                            <td class="align-middle text-center text-md text-nowrap">
                                <a class="btn btn-sm bg-gradient-success text-dark" id="push-onesignal" data-url="index.php?com=pushOnesignal&act=sync&id=<?=$items[$i]['id']?>" title="Đẩy tin"><i class="fas fa-paper-plane mr-2"></i>Đẩy tin</a>
                            </td>
                            <td class="align-middle text-center text-md text-nowrap">
