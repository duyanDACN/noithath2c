...
<section class="content">
    ...
    <div class="card-footer-list form-group-category text-sm bg-white">
            ...
            <?php } else { ?>
                <tbody>
                    <?php for($i=0;$i<count($items);$i++) {
                        ...
                        <?php 
                        $countItems = $d->rawQuery("select id from #_news where id_cat = ? and type = ? and hienthi > 0 order by stt,id desc",array($items[$i]['id'],$type));
                        ?>
                        <tr>
