        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group-category row">
                    ...
                    <?php } ?>
                    <?php if(isset($config['newsletter'][$type]['congtrinh']) && $config['newsletter'][$type]['congtrinh'] == true) { ?>
                        <div class="form-group col-md-4">
                    ...
                    <?php } ?>
                    <?php if(isset($config['newsletter'][$type]['phongcach']) && $config['newsletter'][$type]['phongcach'] == true) { ?>
                        <div class="form-group col-md-4">
