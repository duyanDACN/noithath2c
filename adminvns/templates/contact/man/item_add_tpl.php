...
<section class="content">
    <form method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
        ...
        <div class="card card-vns card-outline text-sm">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <?php } else { ?>
                            <a class="bg-gradient-secondary text-dark d-inline-block p-2 rounded mb-1" href="#" title="Tập tin trống"><i class="fas fa-download mr-2"></i>Tập tin trống</a>
                        <?php } ?>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="data[congtrinh]" id="congtrinh" placeholder="Công trình" value="<?=@$item['congtrinh']?>">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="phongcach">Phong cách:</label>
                        <input type="text" class="form-control" name="data[phongcach]" id="phongcach" placeholder="Phong cách" value="<?=@$item['phongcach']?>">
                    </div>
                    <div class="form-group col-md-4">
