            ...
            <?php } else { ?>
                <tbody>
                    <?php for($i=0;$i<count($items);$i++) { ?>
                        <?php 
                        $countItems = $d->rawQuery("select id from #_product where id_brand = ? and type = ? and hienthi > 0 order by stt,id desc",array($items[$i]['id'],$type));
                        ?>
                        <tr>
                     ...
                     <?php } } ?>
                     <td class="align-middle text-center">
                        <a class="text-dark" title="Số sản phẩm"><?=count($countItems)?></a>
                    </td>
                    <td class="align-middle text-center">
                     <div class="custom-control custom-checkbox my-checkbox">
